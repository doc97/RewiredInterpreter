...
namespace Rewired.Interpreter.Tests {
    ...
    public class TestTokenizer {
        ...
        [TestCase("<", ExpectedResult = TokenType.LessThan)]
        [TestCase(">", ExpectedResult = TokenType.GreaterThan)]
        [TestCase("<=", ExpectedResult = TokenType.LessThanOrEqual)]
        [TestCase(">=", ExpectedResult = TokenType.GreaterThanOrEqual)]
        [TestCase("==", ExpectedResult = TokenType.Equal)]
        [TestCase("!=", ExpectedResult = TokenType.NotEqual)]
        [TestCase("&&", ExpectedResult = TokenType.LogicalAnd)]
        [TestCase("||", ExpectedResult = TokenType.LogicalOr)]
        [TestCase(":=", ExpectedResult = TokenType.Assign)]
        [TestCase("func", ExpectedResult = TokenType.Func)]
        [TestCase("if", ExpectedResult = TokenType.If)]
        [TestCase("else", ExpectedResult = TokenType.Else)]
        ...
        [TestCase("if", ExpectedResult = "if")]
        [TestCase("else", ExpectedResult = "else")]
